                    ...
                    >
                        ...
                        >
                            <input
                                ...
                                className="w-full p-3 text-sm outline-none rounded-md sm:rounded-r-none sm:rounded-l-md text-white bg-transparent border border-gray-600 placeholder-gray-400 focus:border-white focus:ring-0"
                                value={email}
