  ...
  return (
    <div
      ...
      style={{
        ...
        height: "4px",
        backgroundColor: ACCENT_BLUE,
        // ✅ FIX: Center the underline relative to the text by using '0 auto' for margin
...
const AnimatedCard = ({
  ...
  return (
    <div
      // ⭐️ Apply glow ref
      ref={glowProps.ref}
      // ⭐️ Apply glow event handlers
      {...glowProps}
      style={{
        backgroundColor: DEEP_BLUE,
        padding: "30px",
        borderRadius: "15px",
        // ⭐️ Use 'isHovered' from hook
        boxShadow: isHovered
          ? `0 8px 30px rgba(0, 0, 0, 0.7), 0 0 20px ${ACCENT_BLUE}80`
          : `0 4px 15px rgba(0, 0, 0, 0.4)`,
        border: isHovered
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            From idea to implementation — we help students and graduates turn
            academic visions into impactful digital solutions.
          </p>
      ...
      >
        ...
        >
          {" "}
          {/* ✅ FIX: Ensure SectionTitle is centered */}
          <span className="bg-gradient-to-r from-[#38b6ff] to-[#000433] bg-clip-text text-transparent animate-gradient">
            What We Offer
          </span>
        </SectionTitle>
        <AccentDivider />{" "}
        {/* The divider component is designed to be centered by default */}
        <p
          style={{
            color: LIGHT_GREY,
            fontSize: isMobile ? "1rem" : "1.15rem",
        ...
        >
          Ucentric provides complete assistance in college and final-year
          projects. Our service includes everything from{" "}
          <b>project planning and topic selection</b> to{" "}
          <b>development, testing, documentation, and presentation</b>. We
          ensure you not only get a high-quality project but also understand it
          thoroughly. We cover a vast array of technologies including{" "}
      ...
      {/* ========================================================================= */}
      {/* 8. CALL-TO-ACTION SECTION (Footer-like) */}
      {/* ========================================================================= */}
      <div
        // ✅ FIX: Removed the stray top padding/margin/height which was causing the black space
        style={{
          width: "100%",
          height: isMobile ? "50vh" : "50vh", // ⭐️ Responsive height
          minHeight: isMobile ? "350px" : "400px", // ⭐️ Responsive min-height
      ...
      >
        ...
        >
          ...
          >
            Get professional guidance, quality code, and perfect documentation —
            all in one place.
          </p>
        ...
        {`
            ...
            0%, 100% { transform: translateX(0); }
             ...
             .animate-gradient {
                    ...
                    /* Custom scrollbar hiding for the horizontal scroll section */
