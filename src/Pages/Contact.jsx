  ...
  return (
    <div className="min-h-screen text-white bg-black">
      ...
      <section className="py-16 px-6 sm:px-10 lg:px-16 text-center bg-gradient-to-b from-[#000433]/60 to-black mt-20">
        ...
        >
          Whether you’re looking to collaborate, need product support, or just
          want to say hello — we’re here to help. Reach out to us and we’ll get
      ...
      <section className="relative px-6 text-center bg-black sm:px-10 lg:px-16 lg:text-left">
        ...
        >
          ...
          >
            <p className="text-gray-400">
              We value your time — get timely updates, quick resolutions, and
          ...
          >
            <p className="text-gray-400">
              Contact us however you prefer — phone, email, or enquiry form. We
